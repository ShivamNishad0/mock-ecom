...
const Login = ({ onLoginSuccess, onSwitchToSignup }) => {
  ...
  return (
    <div style={containerStyle}>
      <h2 style={{ textAlign: 'center', marginBottom: '20px', color: '#333', textShadow: '1px 1px 2px rgba(0,0,0,0.2)' }}>Login</h2>
      <form onSubmit={handleSubmit}>
        ...
        <p style={{ marginTop: '15px', textAlign: 'center', fontSize: '14px' }}>
          ...
          <button onClick={onSwitchToSignup} style={linkButton}>Signup</button>
        </p>
      </form>
    </div>
  );
